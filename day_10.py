...
the charging outlet, the adapters, and your device. What is the number of 1-jolt
...
count_three = list_steps.count(3) + 1
count_one = list_steps.count(1) + 1


print(f"The final result is {count_three * count_one}.")
